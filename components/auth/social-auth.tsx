...
export function SocialAuth({ onSocialLogin }: SocialAuthProps) {
  const socialProviders = [
    ...
    },
    {
      id: "microsoft",
      name: "Microsoft",
      bgColor: "hover:bg-gray-50 hover:border-gray-200",
    ...
    <div className="space-y-3">
      {socialProviders.map((provider) => (
        <Button
          ...
          type="button"
          variant="outline"
          className={`w-full h-12 border-2 transition-all duration-200 ${provider.bgColor} ${provider.textColor} font-medium`}
